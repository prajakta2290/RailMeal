    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 -mt-10">
                {/* Search Card */}
                <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 p-8 mb-12 relative z-10 ring-1 ring-black/5">
                    {/* Search Type Tabs */}
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-16">
                    {[
                        { icon: Utensils, title: "E-Catering", desc: "Order from top rated restaurants at upcoming stations.", color: "text-blue-600", bg: "bg-blue-50", cardBg: "bg-blue-50/30", border: "border-blue-100 hover:border-blue-200", link: "/restaurants" },
                        { icon: Coffee, title: "Pantry Car", desc: "Official IRCTC pantry food delivered to your seat.", color: "text-orange-600", bg: "bg-orange-50", cardBg: "bg-orange-50/30", border: "border-orange-100 hover:border-orange-200", link: "/restaurants?type=pantry" },
                        { icon: Clock, title: "Pre-Order", desc: "Schedule your meals in advance for the whole journey.", color: "text-green-600", bg: "bg-green-50", cardBg: "bg-green-50/30", border: "border-green-100 hover:border-green-200", link: "/restaurants" }
                    ].map((item, idx) => (
                        <div
                            key={idx}
